      ...
      <div className="blogs-grid">
        ...
        <div className="blog-card">
          ...
          <div className="blog-card-content">
            ...
            <h2 className="blog-title">What is OpenRouter and Why Use It?</h2>
            <p className="blog-excerpt">
        ...
        <div className="blog-card">
          ...
          <div className="blog-card-content">
            ...
            <h2 className="blog-title">Building Your First RAG System</h2>
            <p className="blog-excerpt">
        ...
        <div className="blog-card">
          ...
          <div className="blog-card-content">
            ...
            <h2 className="blog-title">Advanced Prompt Engineering Patterns</h2>
            <p className="blog-excerpt">
        ...
        <div className="blog-card">
          ...
          <div className="blog-card-content">
            ...
            <h2 className="blog-title">Mastering Function Calling with LLMs</h2>
            <p className="blog-excerpt">
        ...
        <div className="blog-card">
          ...
          <div className="blog-card-content">
            ...
            <h2 className="blog-title">Getting Started with LangChain</h2>
            <p className="blog-excerpt">
