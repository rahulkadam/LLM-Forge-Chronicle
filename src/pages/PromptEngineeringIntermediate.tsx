      ...
      <div className="prompt-engineering">
        ...
        <section className="introduction">
          <p>
            ...
            enable
            greater control over language model outputs. This guide covers role-based prompting, self-refinement,
            model-specific
...
[configuration details here]`}
        ...
        <section className="model-specific-techniques">
          ...
          <p>
            Different models respond better to different prompting techniques. Here are some model-specific
            optimizations:
          </p>
          ...
          <div className="model-grid">
            <div className="model-card">
              ...
              <ul>
                ...
                <li><strong>Temperature Setting:</strong> Adjust from 0 (deterministic) to 1+ (creative) based on task
                  needs
                </li>
                <li><strong>Function Calling:</strong> Use structured JSON outputs for data extraction tasks</li>
                <li><strong>Token Awareness:</strong> Keep prompts concise but complete; model has ~8K-32K token context
                  window
                </li>
              </ul>
            </div>
            ...
            <div className="model-card">
              ...
              <ul>
                <li><strong>XML Tags:</strong> Use &lt;instructions&gt;, &lt;context&gt;, &lt;example&gt; to structure
                  prompts
                </li>
                <li><strong>Verbose Instructions:</strong> Claude often benefits from detailed, explicit instructions
                </li>
            ...
            <div className="model-card">
              ...
              <ul>
                ...
                <li><strong>Verbosity in Reasoning:</strong> Often benefits from explicit "think step by step"
                  instructions
                </li>
                <li><strong>Specific Prefix/Suffix:</strong> May require special tokens or formats (e.g., "###
                  Instruction:" or "&lt;s&gt;")
                </li>
              </ul>
            </div>
...
Additional Requirements: Include a short shopping list of essential tools`}
        ...
        <section className="next-steps">
          ...
          <p>
            Now that you've learned intermediate prompt engineering techniques, you can explore more advanced concepts
            like
