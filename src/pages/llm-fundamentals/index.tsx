  ...
  return (
      <div className="llm-fundamentals">
        ...
        <div className="parameter-image-container">
          <img src="/llm/llm-model.png" alt="LLM Agent overview" className="full-width-image"/>
        </div>
          ...
          <div className="concept-grid">
            <div className="concept-card">
              ...
              <div className="example">
                Example: When you type "The capital of France is," an LLM predicts "Paris" as the most likely
                continuation.
              </div>
            </div>
            ...
            <div className="concept-card">
              ...
              <div className="example">
                Example: Understanding that "John picked up his coat because he was cold" connects "John" with "he" and
                "cold" with "coat"
              </div>
            </div>
            ...
            <div className="concept-card">
              ...
              <div className="example">
                Example: Instead of asking "Write about dogs," saying "Write a 300-word educational guide about caring
                for large dog breeds" gets more specific results
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="getting-started">
          ...
          <div className="steps-container">
            ...
            <div>
              ...
              <p>
                The way you phrase your requests dramatically affects results. Be clear, specific, and structured in
                your prompts.
            ...
            <div>
              ...
              <p>
                LLMs aren't perfect - they can make mistakes, "hallucinate" incorrect facts, and have knowledge
                cut-offs.
