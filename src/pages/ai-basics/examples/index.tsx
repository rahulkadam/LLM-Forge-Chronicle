...
const Examples: React.FC = () => {
  const handleExampleClick = (category: string, example: string) => {
    trackEvent('Examples', category, example);
  };
    ...
    <div className="examples">
      ...
      <section className="business-examples">
        ...
        <div className="example-grid">
          <div className="example-card" onClick={() => handleExampleClick('Business', 'Email Writing')}>
            <h3>📧 Email Writing</h3>
          ...
          <div className="example-card" onClick={() => handleExampleClick('Business', 'Report Analysis')}>
      ...
      <section className="learning-examples">
        ...
        <div className="example-grid">
          <div className="example-card" onClick={() => handleExampleClick('Learning', 'Concept Explanation')}>
          ...
          <div className="example-card" onClick={() => handleExampleClick('Learning', 'Research Summary')}>
      ...
      <section className="creative-examples">
        ...
        <div className="example-grid">
          <div className="example-card" onClick={() => handleExampleClick('Creative', 'Blog Post')}>
            <h3>✍️ Blog Post</h3>
            <div className="example-content">
          ...
          <div className="example-card" onClick={() => handleExampleClick('Creative', 'Content Ideas')}>
            <h3>🎨 Content Ideas</h3>
            <div className="example-content">
