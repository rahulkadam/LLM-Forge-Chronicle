...
const PromptBasics: React.FC = () => {
  const handleExampleClick = (exampleType: string) => {
    trackEvent('Prompt Basics', 'Example Click', exampleType);
  };

  const handleTemplateClick = (templateType: string) => {
    trackEvent('Prompt Basics', 'Template Click', templateType);
  };
    ...
    <div className="prompt-basics">
      ...
      <section className="prompt-templates">
        ...
        <div className="template-grid">
          <div className="template-card" onClick={() => handleTemplateClick('writing')}>
          ...
          <div className="template-card" onClick={() => handleTemplateClick('analysis')}>
          ...
          <div className="template-card" onClick={() => handleTemplateClick('problem-solving')}>
      ...
      <section className="practice">
        ...
        <div className="practice-grid">
          <div className="practice-card" onClick={() => handleExampleClick('basic')}>
            <h3>Basic Prompt</h3>
          ...
          <div className="practice-card" onClick={() => handleExampleClick('writing')}>
          ...
          <div className="practice-card" onClick={() => handleExampleClick('analysis')}>
