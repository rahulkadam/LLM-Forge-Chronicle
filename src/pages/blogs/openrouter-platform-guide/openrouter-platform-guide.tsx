  ...
  return (
    <div className="blog-post">
      <div className="blog-header">
        ...
        <h1 className="blog-title">OpenRouter: Your Gateway to Multiple LLM Models</h1>
        <div className="blog-meta">
          <span className="publish-date">Published on March 20, 2024</span>
          <span className="reading-time">10 min read</span>
        </div>
        <div className="blog-banner openrouter-banner"></div>
      </div>

      <div className="blog-content">
        <div className="main-content">
          <section className="introduction">
            <h2>What is OpenRouter?</h2>
            <p>
...
const response = await client.chat.completions.create({
  messages: [
    { role: 'user', content: 'Hello, how are you?' }
          ...
          <section className="available-models">
          ...
          <section className="api-key-management">
...
console.log(usage.credits_used);`}
          ...
          <section className="advanced-implementation">
  ...
  rateLimit: {
    ...
    concurrentRequests: 5
          ...
          <section className="getting-started">
            <h2>Getting Started with OpenRouter</h2>
            <div className="feature-grid">
              <div className="feature-card">
                <h3>1. Sign Up</h3>
                <p>
        ...
        <div className="table-of-contents">
          ...
          <ul>
            <li><a href="#introduction">What is OpenRouter?</a></li>
